  ...
  return (
    <>
      ...
      <Box p={5}>
        ...
        {!!issueData && mode === 'grid' && view === 'detail' && <RoadmapGrid viewMode={view} issueData={issueData} />}
        {!!issueData && mode === 'grid' && view === 'simple' && <RoadmapGrid viewMode={view} issueData={issueData} />}
      </Box>
    </>
  );
}
